...
ZiraVoice := TTS_CreateVoice("Microsoft Zira Desktop")
DavidVoice := TTS_CreateVoice("Microsoft David Desktop")
;ToolTip % TTS(Voice, "GetVoices")



speakWait(msg){
	global ZiraVoice
	TTS(ZiraVoice, "SpeakWait", msg)
}

;F5::TTS(ZiraVoice, "ToggleSpeak", gst())	; select some text and press F1
